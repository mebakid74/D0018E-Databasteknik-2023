...
-- Schema mydb_v8
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `mydb_v8` DEFAULT CHARACTER SET utf8 ;
USE `mydb_v8` ;

-- -----------------------------------------------------
-- Table `mydb_v8`.`Users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Users` (
...
-- -----------------------------------------------------
-- Table `mydb_v8`.`Categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Categories` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_Category_Category1`
    ...
    REFERENCES `mydb_v8`.`Categories` (`ID`));

-- -----------------------------------------------------
-- Table `mydb_v8`.`Products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Products` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb_v8`.`Receipts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Receipts` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_Order_Customer1`
    ...
    REFERENCES `mydb_v8`.`Users` (`ID`));
-- -----------------------------------------------------
-- Table `mydb_v8`.`ReceiptItems`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`ReceiptItems` (
  ...
  CONSTRAINT `fk_OrderItems_Order1`
    ...
    REFERENCES `mydb_v8`.`Receipts` (`ID`),
  CONSTRAINT `fk_OrderItems_Products1`
    FOREIGN KEY (`Products_ID`)
    REFERENCES `mydb_v8`.`Products` (`ID`));

-- -----------------------------------------------------
-- Table `mydb_v8`.`Carts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Carts` (
  `Products_ID` INT NOT NULL,
  `Users_ID` INT NOT NULL,
  `Amount` INT NOT NULL,
  ...
  CONSTRAINT `fk_CartItems_Customer1`
    ...
    REFERENCES `mydb_v8`.`Users` (`ID`));
-- -----------------------------------------------------
-- Table `mydb_v8`.`Reviews`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Reviews` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Users_ID` INT NOT NULL,
  `Products_ID` INT NOT NULL,
  ...
  CONSTRAINT `fk_Reviews_Customer1`
    ...
    REFERENCES `mydb_v8`.`Users` (`ID`));
-- -----------------------------------------------------
-- Table `mydb_v8`.`Admins`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Admins` (
  `Users_ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb_v8`.`Collections`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`Collections` (
  `ID` INT NOT NULL,
  `Name` VARCHAR(45) NOT NULL,
  `ImagePath` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `mydb_v8`.`CollectionItems`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`CollectionItems` (
  ...
  CONSTRAINT `fk_CollectionItems_Collections1`
    ...
    REFERENCES `mydb_v8`.`Collections` (`ID`),
  CONSTRAINT `fk_CollectionItems_Products1`
    FOREIGN KEY (`Products_ID`)
    REFERENCES `mydb_v8`.`Products` (`ID`));

-- -----------------------------------------------------
-- Table `mydb_v8`.`ProductFilters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_v8`.`ProductFilters` (
  `Products_ID` INT NOT NULL,
